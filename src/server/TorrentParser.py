...
from common import decode_string, path_join
import operator
...
if __name__ == "__main__":
	info = TorrentInfo("comp.torrent")
	print info.name
	
	files = sorted(info.files,key=operator.itemgetter('path'))
	all = ""
	for i in files:
		all += i["path"] + "\t" + str(i["size"]) + "\t" + str(i["download"])+"\n"
	print all
